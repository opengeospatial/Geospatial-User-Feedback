...
=== ED-06: New QCM_ReproducibleUsage requirement added.
...
=== ED-07: New class QCM_ReproducibleUsage.
...
=== ED-12: New attributes in GUF_UserInformation Data Type.
...
=== ED-14: New "GUF_ApplicationDomain" Data Type added.
...
Related to ED-15 critical change.

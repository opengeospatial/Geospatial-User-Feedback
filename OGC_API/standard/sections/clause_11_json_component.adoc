...
.link:https://github.com/grumets/nimmbus/tree/master/OGC_API/satandard/openapi/schemas/ogcapi_feedback-item.yaml[Schema for a feedback item encoded as GeoJSON (ogcapi_feedback-item.yaml)]
[source,JSON]
----
...
.link:https://github.com/grumets/nimmbus/tree/master/OGC_API/satandard/openapi/schemas/ogcapi_feedback-summary.yaml[Schema for a feedback summary encoded as GeoJSON (ogcapi_feedback-summary.yaml)]
[source,JSON]
----

...
A _feedback summary_ is an object that provides aggregated information about a set of <<feedback_item, feedbacks>> in a <<feedback_collection,feedback collection>> that share the same _target_.

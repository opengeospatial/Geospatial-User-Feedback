...
A _feedback collection_ is an object that provides information about and access to a set of related <<feedback_item, feedbacks>>. Such a collection of user feedbacks forms a user feedback catalog.

The schema for the feedback collection is a specific implementation of the record collection defined in https://docs.ogc.org/DRAFTS/20-004.html#\_clause-core-record\_[OGC API - Records Standard].
...
Although this Standard does not mandate any particular encoding for a collection, a JSON encoding is defined.
...
<<tbl_feedback_catalog>> define the set of properties that may be included in a feedback collection.
...
|id |**required** |A unique identifier for this collection of user feedbacks.
...
|title |optional |A human-readable name given to this collection.
|description |optional |A free-text description of this collection.
|extent |optional |The spatiotemporal coverage of this collection.
...
|https://docs.ogc.org/DRAFTS/20-004.html#\_req_record-collection_records-array-name\_[recordsArrayName] |optional |The name of the array property in the collection used to encode records in-line.  The default value is `records`.
|https://docs.ogc.org/DRAFTS/20-004.html#\_req_record-collection_records\_[records] |optional |An array of records encoded in-line in the collection.
|links |**required** |A list of links related to this collection.
|linkTemplates |optional |A list of link templates related to this collection.
|schemes |optional |A list of schemes related to this collection. |`schemes`
|===
